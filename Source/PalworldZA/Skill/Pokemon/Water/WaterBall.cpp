...
{
	static ConstructorHelpers::FClassFinder<AActor> WaterBallRef(TEXT("/Game/BluePrint/PokemonSkill/BP_WaterBallProjectile.BP_WaterBallProjectile_C"));
...
AActor* AWaterBall::SpawnProjectile(FVector Pos, FRotator Rot)
{
