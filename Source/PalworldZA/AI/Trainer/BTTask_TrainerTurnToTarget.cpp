...
#include "AI/Trainer/BTTask_TrainerTurnToTarget.h"
#include "AIController.h"
#include "BehaviorTree/BlackboardComponent.h"
#include "Interface/TrainerInterface/NPTrainerAIInterface.h"
#include "NpcBBKeys.h"

UBTTask_TrainerTurnToTarget::UBTTask_TrainerTurnToTarget()
{
	NodeName = TEXT("TrainerTurnToTarget");
	bNotifyTick = true;
}

EBTNodeResult::Type UBTTask_TrainerTurnToTarget::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	// 타겟 폰 정보 불러오기 
	APawn* TargetPawn = Cast<APawn>(OwnerComp.GetBlackboardComponent()->GetValueAsObject(BBKEY_TARGETPOKEMON));
	...
	TurnSpeed = AIPawn->GetAITurnSpeed();

	return EBTNodeResult::InProgress;
}

void UBTTask_TrainerTurnToTarget::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
